...
{
    public class LeftDrawer_ListAdapter : BaseAdapter<string>
    {
        List<string> mdata;
        Context mContext;
        public static int[] leftDrawableIconIds;
        ...
        public LeftDrawer_ListAdapter(Context context, List<string> data)
        {
            mContext = context;
            mdata = data;
        }
        ...
        public override View GetView(int position, View convertView, ViewGroup parent)
        {
            ...
            iconImageView.SetImageDrawable(ContextCompat.GetDrawable(MainActivity.mainActivity, leftDrawableIconIds[position]));
