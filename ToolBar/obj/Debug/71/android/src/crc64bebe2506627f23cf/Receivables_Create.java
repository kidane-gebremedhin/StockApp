package crc64bebe2506627f23cf;


public class Receivables_Create
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("ToolBar.Resources.Fragments.Receivables_Create, TenderApp", Receivables_Create.class, __md_methods);
	}


	public Receivables_Create ()
	{
		super ();
		if (getClass () == Receivables_Create.class)
			mono.android.TypeManager.Activate ("ToolBar.Resources.Fragments.Receivables_Create, TenderApp", "", this, new java.lang.Object[] {  });
	}
