...
{
    public class Issuables_Create : SupportFragment, DatePickerDialog.IOnDateSetListener
    {

        private EditText qtyEditText;
        TextView expireDateEditText;
        private Spinner productSpinner;
        private Button submitBtn, IssuablesListBtn;
        ...
        {
            View view = inflater.Inflate(Resource.Layout.Issuables_Create, container, false);
        ...
        private void SubmitBtn_Click(object sender, EventArgs e)
        {
            ...
            Issuables Issuable = new Issuables(0, productId, qty, DateTime.Now);
            if (Issuables.store(Issuable))
            {
                productSpinner.SetSelection(0);
                qtyEditText.Text = "";
                Toast.MakeText(this.Context, "Issuable added successfully", ToastLength.Short).Show();
            }
            else
            {
