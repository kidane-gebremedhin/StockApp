...
{
    public class Issuables_Show : SupportFragment
    {
        MainActivity mainActivity = new MainActivity();

        private TextView productTextView, qtyTextView;
        private ImageView imageImageView;
        private Button IssuablesListBtn;
        ...
        {
            View view = inflater.Inflate(Resource.Layout.Issuables_Show, container, false);
            ...
            IssuablesListBtn = view.FindViewById<Button>(Resource.Id.IssuablesListBtn);
            IssuablesListBtn.Click += IssuablesListBtn_Click;


            if (MainActivity.loggedUser == null)
                IssuablesListBtn.Visibility = ViewStates.Invisible;
            else
                IssuablesListBtn.Visibility = ViewStates.Visible;


            Issuables Issuable = Issuables_Index.Issuable;
            if (Issuable == null)
                return view;
           productTextView.Text = MainActivity.db.Table<Product>().Where(i => i.Id == Issuable.productId).First().name;
            qtyTextView.Text = Issuable.qty.ToString();
        ...
        private void IssuablesListBtn_Click(object sender, EventArgs e)
        {
            if (Issuables_Index.Issuable != null)
            {
